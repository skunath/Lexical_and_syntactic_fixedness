...
data = DiscoFrame.find(:first, :conditions => "disco_data_id in (select id from disco_data where syntactic = 'EN_V_OBJ' and set_id = 3) and w2_fixed_count is null", :order => "rand()")
