...
for item in data
	...
	temp_command1 = "[(lemma='replace1')&(pos='JJ')][(lemma='replace2')&(pos='NN.*')]"
	...
	temp_command2 = "[(lemma!='replace1')&(pos='JJ')][(lemma='replace2')&(pos='NN.*')]"
	...
	temp_command3 = "[(lemma='replace1')&(pos='JJ')][(lemma!='replace2')&(pos='NN.*')]"
	...
	temp_command4 = "[(lemma!='replace1')&(pos='JJ')][(lemma!='replace2')&(pos='NN.*')]"
