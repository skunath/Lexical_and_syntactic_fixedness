...
#select d.w1, d.w2, d.coarse, d.syntactic_fixedness, d.pmi, n.x_square, n.log_likelihood, o.lex_fix, o.overall_fix, o.complexity_0, complexity_1, complexity_2, complexity_3, complexity_4,length_0, length_1, length_2, length_3, length_4 from 
#disco_data d 
...
test_data = File.open("test-obj-coarse-list-3.txt")
test_scores = {}
...
for line in test_data
	...
	test_scores[line_split[0]] = line_split[2].split(":")[1].strip
end

test_out = File.open("out-obj-coarse-list.txt", "w")

counter = 1
for item in data
	break if item.w1.nil?
	line = "EN_V_OBJ\t"
	puts item.w1 + "--<"
